  ...
  const toolsSchema = [
    {
      ...
      url: `${baseUrl}/tools/background-snippets`,
      description:
    ...
    },
    {
      ...
      url: `${baseUrl}/tools/mesh-gradients`,
      description:
    ...
    },
    {
      ...
      "@type": "SoftwareApplication",
      name: "SVG Line Draw",
      url: `${baseUrl}/tools/svg-line-draw`,
      description:
