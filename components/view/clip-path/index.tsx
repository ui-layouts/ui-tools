    ...
    <>
      ...
      <div
        ...
        className={`relative grid h-full min-h-0 grid-cols-12 gap-3 p-3 ${
          isSidebarExpanded
            ? "lg:grid-cols-[70px_340px_minmax(0,1fr)]"
      ...
      >
            ...
            <div className="space-y-2">
              {[
                ...
                <button
                  ...
                  className={`grid h-12 w-full place-items-center rounded-md border px-1 py-1 font-semibold text-[10px] transition-colors ${
                    activeSidebarTab === item.key
                      ? "border-primary bg-primary text-primary-foreground"
                      : "bg-main hover:bg-accent"
                  }`}
                >
                  <item.icon className="mb-0.5 h-5 w-4" />
                  <span>{item.label}</span>
                </button>
              ))}
            </div>
            <div className="space-y-2">
              <ThemeSwitch className="dark:bg-black bg-white w-full border rounded-lg" />
              <Button
                type="button"
                variant="outline"
                size="icon"
        ...
        <div className="col-span-12 h-full min-h-0 lg:col-auto relative">
